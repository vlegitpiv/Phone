...
./adb shell pm uninstall -k --user 0 com.reachjunction.card.game.solitaire
...
./adb shell pm uninstall -k --user 0 com.qeeq.android
...
./adb shell pm disable-user --user 0 com.mediatek.callrecorder
